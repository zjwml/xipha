    ...
    <t-card title="搜索器">
      <t-form ref="form" :data="formData" label-width="120px" scroll-to-first-error="smooth">
        ...
        <t-form-item label="必需回路" prop="circuitRequirements">
          <t-cascader v-model="formData.circuitRequirements" :options="circuitOptions" :show-all-levels="false"
            multiple>
          </t-cascader>
        </t-form-item>
        <t-form-item label="排除回路" prop="circuitExclusions">
          <t-cascader v-model="formData.circuitExclusions" :options="circuitOptions" :show-all-levels="false"
            multiple>
          </t-cascader>
        </t-form-item>
      </t-form>
